...
//   UNDEF       : 未定義値
// ------------------------------------------------------------
enum Type { INT, INT64, DOUBLE, SYMBOL, PAIR, CLOSURE, CONTINUATION, PRIMITIVE, PORT, UNDEF, VECTOR };
...
//   END           : 入力終端
// ------------------------------------------------------------
enum TokenType { TOK_LPAREN, TOK_RPAREN, TOK_DOT, TOK_INT, TOK_SYM, TOK_QUOTE, TOK_BACKQUOTE, TOK_UNQUOTE, TOK_SPLICE, TOK_HASH_LPAREN, TOK_END };
struct Token {
    TokenType type;
    std::string str;
};
